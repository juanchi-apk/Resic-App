...
object ProductRepository {
    ...
    fun get() : List<Product> {
        return products.toList() //TODO Implementar solucion para obtener todos los paquetes turisticos
    }

    fun getById(id: Long) : Product {
        val filteredProduct = products.filter { it.id.equals(id) }
        return filteredProduct[0] //TODO Implementar solucion para obtener el paquete turistico solicitado
    }
